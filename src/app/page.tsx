...
export default function Home() {
  ...
  return (
    <div className="space-y-16 pb-16">
      ...
      <section>
        <h2 className="text-3xl font-bold text-center mb-8 font-headline text-secondary-foreground">Featured Products</h2>
      ...
      <section>
        <div className="bg-accent/20 rounded-lg p-8 md:p-12 grid md:grid-cols-3 gap-8 items-center">
            <div className="md:col-span-2 space-y-4">
                 <h2 className="text-3xl font-bold font-headline text-secondary-foreground">Our Commitment to the Planet</h2>
